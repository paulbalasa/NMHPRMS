...
{
    public partial class usrCntrlPatientRecordDoctor : UserControl
    {
        MySQL_Code conStr = new MySQL_Code();
        public MySqlConnection conn = new MySqlConnection(MySQL_Code.connectionString);

        public usrCntrlPatientRecordDoctor()
        {
            InitializeComponent();
            autoCompleteLastname();
        }

        private void usrCntrlPatientRecordDoctor_Load(object sender, EventArgs e)
        {
            getDataSet();
